*******************************************************
* 08_table_S11_age_strata.do — Temperature effects stratified by median age
* Data: data/processed/processed_data.csv
* Outputs:
*   - outputs/tables/supplementary/Table_S11a_medageStrata_PI0.tex (Both sexes)
*   - outputs/tables/supplementary/Table_S11b_medageStrata_PI1.tex (Men)
*   - outputs/tables/supplementary/Table_S11c_medageStrata_PI2.tex (Women)
*
* Description:
...
foreach dep of local outcomes {
    ...
    * Determine outcome label and filename
    ...
    local fname = cond("`dep'"=="pi0", "Table_S11a_medageStrata_PI0.tex", ///
                  cond("`dep'"=="pi1", "Table_S11b_medageStrata_PI1.tex", ///
                       "Table_S11c_medageStrata_PI2.tex"))
...
di as text "  - Table_S11a_medageStrata_PI0.tex (Both sexes)"
di as text "  - Table_S11b_medageStrata_PI1.tex (Men)"
di as text "  - Table_S11c_medageStrata_PI2.tex (Women)"
