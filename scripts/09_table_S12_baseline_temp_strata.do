...
* Outputs:
*   - outputs/tables/supplementary/Table_S12a_baselineTemp_PI0.tex (Both sexes)
*   - outputs/tables/supplementary/Table_S12b_baselineTemp_PI1.tex (Men)
*   - outputs/tables/supplementary/Table_S12c_baselineTemp_PI2.tex (Women)
...
foreach dep of local outcomes {
    ...
    * Determine outcome label and filename
    ...
    local fname = cond("`dep'"=="pi0", "Table_S12a_baselineTemp_PI0.tex", ///
                  cond("`dep'"=="pi1", "Table_S12b_baselineTemp_PI1.tex", ///
                       "Table_S12c_baselineTemp_PI2.tex"))
...
di as text "  - Table_S12a_baselineTemp_PI0.tex (Both sexes)"
di as text "  - Table_S12b_baselineTemp_PI1.tex (Men)"
di as text "  - Table_S12c_baselineTemp_PI2.tex (Women)"
